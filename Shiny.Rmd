               ...
               div(style="padding: 1px 0px; width: '100%'",
                   ...
                   navbarPage(title=div(img(src="logo.png"), "Women 2017 Survey Analysis"),
                              ...
                              (navbarMenu("CTA", (tabPanel("CTA Visual",
                                          ...
                                          tabPanel("CTA Data", 
                                                   includeMarkdown("./CTA1.Rmd"),
                                                   hr()))),
                              
                              tabPanel("Comments About FreeQuency",
                                       includeMarkdown("./Freequincy.Rmd"),
                                       hr()),
...
server <- function(input, output, session) {
  ...
  output$image1 <- renderImage({list(src="CTA1.png")},deleteFile=FALSE)
